...
// temporary plan9 hacks
#define LOGIN_NAME_MAX _POSIX_NAME_MAX
ssize_t sendmsg(int fd, const struct msghdr *msg, int flags) { return -1; }
// end of temporary plan9 hacks. we need to implement sendmsg in network
...
static const struct {
	...
	AF_UNIX,
// TODO: change this to something plan9-compatible
	"/var/run/nscd/socket"
};
