...
{
return( *fwdimp((id)self,aSelector,(IMP)selptrfwd))((id)self,aSelector);
}

static id i_Object_perform_with_(struct Object_PRIVATE *self,SEL _cmd,SEL aSelector,id anObject)
{

return( *fwdimp((id)self,aSelector,(IMP)selptrfwd))((id)self,aSelector,anObject);
}

static id i_Object_perform_with_with_(struct Object_PRIVATE *self,SEL _cmd,SEL aSelector,id anObject,id otherObject)
{

return( *fwdimp((id)self,aSelector,(IMP)selptrfwd))((id)self,aSelector,anObject,otherObject);
}
...
return( *fwdimp((id)self,aSelector,(IMP)selptrfwd))((id)self,aSelector,anObject,otherObject,thirdObj);
}
