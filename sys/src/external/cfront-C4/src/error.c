...
static const char *abbrev_tbl[26] = {((const char *)" argument"),    ((const char *)" base"),
                                     ((const char *)" class"),       ((const char *)" declaration"),
                                     ((const char *)" expression"),  ((const char *)" function"),
                                     ((const char *)" global"),      ((const char *)"H"),
                                     ((const char *)" initialize"),  ((const char *)"J"),
                                     ((const char *)" constructor"), ((const char *)" list"),
                                     ((const char *)" member"),      ((const char *)" name"),
                                     ((const char *)" object"),      ((const char *)" pointer"),
                                     ((const char *)" qualifie"),    ((const char *)" reference"),
                                     ((const char *)" statement"),   ((const char *)" type"),
                                     ((const char *)" undefined"),   ((const char *)" variable"),
                                     ((const char *)" with"),        ((const char *)" expected"),
                                     ((const char *)" template"),    ((const char *)" parameter")};
...
void error_init__Fv(void) {
    ...
    ea0 =
        ((__0__X26 = 0),
         (((__0__X26 || (__0__X26 = (struct ea *)__nw__FUl((size_t)(sizeof(struct ea))))) ? 0 : 0),
          __0__X26));
}
...
void print_loc__Fv(void) {
    ...
    __1dl =
        ((Cdcl && ((Cdcl->base__4node == 85) || (Cdcl->base__4node == 123))) ? (&Cdcl->where__4name)
                                                                             : (((struct loc *)0)));
    if ((__1sl && __1dl) && (__1sl->file__3loc == __1dl->file__3loc)) {
        if (__1sl->line__3loc <= __1dl->line__3loc) {
            if ((curloc.file__3loc == __1dl->file__3loc) && (curloc.line__3loc < __1dl->line__3loc))
...
static void print_context__Fv(void) { fputc((int)'\n', out_file); }
...
int error__FPCc(const char *__1s) { return error__FiPCc(0, __1s); }
...
int error__FiPCc(int __1t, const char *__1s) {
    return error__FiP3locPCcRC2eaN34(__1t, &dummy_loc, __1s, (const struct ea *)ea0,
                                     (const struct ea *)ea0, (const struct ea *)ea0,
                                     (const struct ea *)ea0);
}

int error__FPCcRC2eaN32(const char *__1s, const struct ea *__1a0, const struct ea *__1a1,
                        const struct ea *__1a2, const struct ea *__1a3) {
    return error__FiP3locPCcRC2eaN34(0, &dummy_loc, __1s, __1a0, __1a1, __1a2, __1a3);
}

int error__FP3locPCcRC2eaN33(struct loc *__1lc, const char *__1s, const struct ea *__1a0,
                             const struct ea *__1a1, const struct ea *__1a2,
                             const struct ea *__1a3) {
    return error__FiP3locPCcRC2eaN34(0, __1lc, __1s, __1a0, __1a1, __1a2, __1a3);
}

int error__FiPCcRC2eaN33(int __1t, const char *__1s, const struct ea *__1a0, const struct ea *__1a1,
                         const struct ea *__1a2, const struct ea *__1a3) {
...
int error__FiP3locPCcRC2eaN34(int __1t, struct loc *__1lc, const char *__1s, const struct ea *__1a0,
                              const struct ea *__1a1, const struct ea *__1a2,
                              const struct ea *__1a3) {
    if ((suppress_error && (__1t != 'i')) && (__1t != 'd'))
        return 0;
...

    {
...

        {
...

            {
                ...
                __vec_new(((void *)__1argv), (sizeof(struct ea[4])) / (sizeof(struct ea)),
                          sizeof(struct ea), ((void *)__ct__2eaFv));
                __1a = __1argv;
                (__1argv[0]) = (*__1a0);
                (__1argv[1]) = (*__1a1);
                (__1argv[2]) = (*__1a2);
                    ...
                    if (('A' <= __1c) && (__1c <= 'Z'))
                        ...
                        case 'k': {
                            ...
                            if (((0 < __5x) && (__5x <= 255)) && (keys[__5x]))
                                fprintf(out_file, (const char *)" %s", keys[__5x]);
                            else
                        ...
                        case 'n': {
                            ...
                            if (__5nn && __5nn->__O2__4expr.string) {
                                if ((((__5nn->__O2__4expr.string[0]) == '_') &&
                                     ((__5nn->__O2__4expr.string[1]) == '_')) &&
                                    ((__5nn->__O2__4expr.string[2]) == 'C'))
                                    break;
                                emode = 1;
                                fputc((int)' ', out_file);
                        ...
                        case 'a': {
                            ...
                            __5nn = (((struct name *)(((struct name *)__1a->__O1__2ea.p))));
                            if ((__5nn->__O1__4expr.tp->base__4node != 108) &&
                                (__5nn->__O1__4expr.tp->base__4node != 76)) {
                                struct ea __0__V27;

                                error__FiPCcRC2eaN33(
                                    (int)'i', (const char *)"%n not function",
                                    (const struct ea *)(((&__0__V27)->__O1__2ea.p =
                                                             ((const void *)__5nn)),
                                                        (&__0__V27)),
                                    (const struct ea *)ea0, (const struct ea *)ea0,
                                    (const struct ea *)ea0);
                        ...
                        case 'o':
                            fprintf(out_file, (const char *)" 0%o",
                                    ((unsigned int)__1a->__O1__2ea.i));
                            break;
                        ...
                        case 's': {
                            ...
                            if (__5s)
                                (fputs((const char *)(((char *)__1a->__O1__2ea.p)), out_file),
                                 fputc((int)' ', out_file));
                            break;
                        }
                        }
                ...
                case 's':
                    if (13 < (++error_count)) {
                        fprintf(_get_stderr(), (const char *)"Sorry, too many errors\n");
                        ext__Fi(7);
                    }
                }
