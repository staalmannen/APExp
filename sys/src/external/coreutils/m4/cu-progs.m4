...
no_install_progs_default='arch coreutils hostname kill uptime chcon runcon'
...
gl_INCLUDE_EXCLUDE_PROG([optional_bin_progs], [arch,coreutils,hostname,kill,uptime])
