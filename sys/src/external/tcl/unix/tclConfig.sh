...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/jens/Devel/APExp/sys/src/external/tcl/unix -ltcl9.0'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/local/lib -ltcl9.0'
...
# compiled.
TCL_SRC_DIR='/home/jens/Devel/APExp/sys/src/external/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/jens/Devel/APExp/sys/src/external/tcl/unix -ltclstub'
...
TCL_BUILD_STUB_LIB_PATH='/home/jens/Devel/APExp/sys/src/external/tcl/unix/libtclstub.a'
