...
set(LIBXML2_INCLUDE_DIR    /usr/local/include/libxml2)
set(LIBXML2_LIBRARY_DIR    /usr/local/lib)

find_library(LIBXML2_LIBRARY NAMES xml2 HINTS ${LIBXML2_LIBRARY_DIR} NO_DEFAULT_PATH)
find_program(LIBXML2_XMLCATALOG_EXECUTABLE NAMES xmlcatalog HINTS /usr/local/bin NO_DEFAULT_PATH)
find_program(LIBXML2_XMLLINT_EXECUTABLE NAMES xmllint HINTS /usr/local/bin NO_DEFAULT_PATH)
