...
/*added for definition of FILE and other stuff */
...
/* Read input, up to (and including) the next occurrence of DELIMITER, from
   ...
   *LINEPTR is a pointer returned from malloc (or NULL), pointing to *LINESIZE
   ...
   NUL terminator), or -1 on error or EOF.  */ /* here a problem, last name FILE */
extern ssize_t getdelim (char **lineptr, size_t *linesize, int delimiter, FILE *stream); 
# endif
#elif defined GNULIB_POSIXCHECK
# undef getdelim
